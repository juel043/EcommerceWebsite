        ...
        <div class="col-md-12" style="margin-top: 5px;">      
          ...
          <div class="row">
            <div class="col-sm-4 text-center">
              ...
              <div class="mb-3">
                           <i class="glyphicon glyphicon-star-empty   mr-1 main_star"></i>
                            <i class=" glyphicon glyphicon-star-empty    mr-1 main_star"></i>
                            <i class=" glyphicon glyphicon-star-empty   mr-1 main_star"></i>
                            <i class=" glyphicon glyphicon-star-empty   mr-1 main_star"></i>
                            <i class=" glyphicon glyphicon-star-empty   mr-1 main_star"></i>
            ...
            <div class="col-sm-4 text-center" style="margin-left: 250px;">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <h4 class="text-center mt-2 mb-4">
              <i class="glyphicon glyphicon-star star-light submit_star mr-1" id="submit_star_1" data-rating="1"></i>
                    <i class="glyphicon glyphicon-star star-light submit_star mr-1" id="submit_star_2" data-rating="2"></i>
                    <i class="glyphicon glyphicon-star star-light submit_star mr-1" id="submit_star_3" data-rating="3"></i>
                    <i class="glyphicon glyphicon-star star-light submit_star mr-1" id="submit_star_4" data-rating="4"></i>
                    <i class="glyphicon glyphicon-star star-light submit_star mr-1" id="submit_star_5" data-rating="5"></i>
            </h4>
             <div class="form-group" style="display:none;">
              <input type="text" name="vhid" id="vhid" class="form-control" placeholder="Enter Vechicle ID " value="<?php echo $vhid ?>" />
            </div>
            <div class="form-group">
  ...
  var rating_data = 0;
    ...
    $(document).on('mouseenter', '.submit_star', function(){
        ...
        for(var count = 1; count <= rating; count++)
        {
            ...
            $('#submit_star_'+count).addClass('alert-warning');
      ...
      function reset_background()
    {
        for(var count = 1; count <= 5; count++)
        {
            ...
            $('#submit_star_'+count).removeClass('alert-warning');
        ...
        else
        {
            $.ajax({
                ...
                method:"POST",
                data:{vhid:vhid,rating_data:rating_data, user_name:user_name, user_review:user_review},
  ...
  function load_rating_data()
    {
      var vhid = $('#vhid').val();
        ...
        $.ajax({
            url:"submit_rating.php",
            method:"POST",
            data:{action:'load_data',vhid:vhid},
            dataType:"JSON",
            success:function(data)
            {
                ...
                if(data.review_data.length > 0)
                {
                    ...
                    for(var count = 0; count < data.review_data.length; count++)
                    {
                        ...
                        for(var star = 1; star <= 5; star++)
                        {
                            ...
                            html += '<i class="glyphicon glyphicon-star '+class_name+' mr-1"></i>';
                        }
